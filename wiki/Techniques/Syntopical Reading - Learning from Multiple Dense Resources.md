---
title: "Syntopical Reading - Learning from Multiple Dense Resources"
type: technique
status: seed
created: 2026-05-15
updated: 2026-05-15
...
| Layer | Source Type              | What It Gives You                              | Why It Matters |
|-------|--------------------------|------------------------------------------------|----------------|
| 0     | Images & diagrams        | Fast visual chunks and relationships           | Lowest load way to make the topic feel real before words |
| 1     | Wikipedia / headings     | Organizing skeleton, major branches, vocabulary | Shows the shape of the field without high density |
| 2     | Textbook or review       | Clearer conceptual treatment at moderate load  | Fills relationships while the scaffold is still forming |
| 3     | Research articles        | Precision, methods, edge cases, disagreements  | New information now has places to land |
...
- [[wiki/Techniques/Prestudy|Prestudy]] — the foundation this technique extends
- [[wiki/Techniques/Bear Hunter System|Bear Hunter System]] — syntopical reading is BHS applied to multiple dense sources
- [[wiki/Techniques/Aim|Aim]] — the orientation phase becomes critical when sources are both dense and multiple
- [[wiki/Dimensions/Deep Processing|Deep Processing]] — this is deep processing under high element interactivity across sources
- [[wiki/Concepts/Cognitive Load & What Mental Effort Is Trying to Cue|Cognitive Load & What Mental Effort Is Trying to Cue]] — the feeling that an article "isn't written in English" is usually a readiness signal, not a source problem
...
- Live Clinic 44: Syntopical reading - learning from multiple, dense resources (Justin Sung with Andrew)
