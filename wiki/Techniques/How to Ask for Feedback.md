...
Too broad with too little information: general feedback on everything, with low actionability.
Narrow with too little information: precise feedback on the wrong thing, because the context is missing.
Narrow with enough information: targeted feedback on the right area, directly linked to the learning goal.
...
1. Reading the response objectively — without rushing to conclusions, especially if there is initial disagreement.
2. Building an action plan — identifying key areas, prioritizing them, and defining specific experiments.
3. Testing and reviewing — following the plan, trying modifications, and returning for more feedback only when the current round of experiments is exhausted.
...
- ICS Learning Support: "How to ask for feedback"
