...
[[wiki/Techniques/Aim|Aim]] is about **how** the mind is pointed during that work.
...
5. Do a light [[wiki/Techniques/Shoot|Shoot]] pass on the biggest ideas.
...
Prestudy sits before [[wiki/Techniques/Bear Hunter System|Bear Hunter System]] as the first contact layer.

The clean handoff:

1. **Prestudy**: build the rough frame.
2. [[wiki/Techniques/Aim|Aim]]: sharpen the frame into importance and relationship questions.
3. [[wiki/Techniques/Shoot|Shoot]]: use the source to answer, test, and revise.
