...
- [[wiki/Dimensions/Deep Processing/Mindmaps|Non-Linear Note-Making]]: the note-taking page that exists
- [[wiki/Dimensions/Deep Processing/Importance-Based Chunking|Chunking as a Technique]]: grouping so the material can be held in mind
- [[wiki/Dimensions/Deep Processing/Importance-Based Chunking|Importance-Based Chunking]]: grouping by what is most worth holding first
...
- [[wiki/Dimensions/Dimensions of Learning|Dimensions of Learning]]: the five-part framework whose goals these methods turn into actions
- [[wiki/Concepts/Four Stages of Competence|Four Stages of Competence]]: conscious competency explained in ordinary words

## Sources

- Paul A. Kirschner, John Sweller, and Richard E. Clark, "Why Minimal Guidance During Instruction Does Not Work," *Educational Psychologist* 41(2) (2006). Cited only as a warning about a name clash: the education-literature name "inquiry-based learning" often means the opposite of this vault's structured-questions-before-consuming.
- Four stages of competence, Broadwell / Burch popularization. An informal source for "conscious competency," and not a course citation.
