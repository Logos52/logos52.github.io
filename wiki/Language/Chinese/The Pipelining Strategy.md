...
- **Session 1 — word, one direction.** Drill the pronunciation–meaning pair as a spoken-word card, with no written form anywhere on the card.
- **Session 2 — word, reversed.** Drill the same pair in the opposite direction. The reversal is markedly lighter work because the forward link already exists; relearning an association backwards costs far less than learning it fresh.
