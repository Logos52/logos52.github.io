...
- [Vietnamese grammar overview](https://en.wikipedia.org/wiki/Vietnamese_grammar) for analytic grammar, SVO order, classifiers, and question-word behavior.
- [Vietnamese Maestro - Placement of question words](https://vietnamesemaestro.com/grammar/placement-of-question-words) for wh-in-situ question-word placement.
- [Migaku - Vietnamese classifiers](https://migaku.com/blog/language-fun/vietnamese-classifiers) for noun phrase/classifier order and regional note.
- [The Languages - Vietnamese aspect markers](https://thelanguages.com/learn/vietnamese/foundations/vi-a1-4/2) for `đã`, `đang`, `sẽ`, and `rồi` as aspect/time markers.
