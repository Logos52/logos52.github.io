...
<text x="340" y="126" font-size="10.5" fill="currentColor" opacity="0.6" text-anchor="start">than the ratings did (shape only, no counts given)</text>
...
<text x="470" y="174" font-size="10" fill="currentColor" opacity="0.6" text-anchor="start">of the 15% to 22% fall</text>
