...
The steps of a method can look correct while the cognition is wrong. A mind map can become decoration. Highlighting can become recognition. Retrieval can become guessing without diagnosis. [[wiki/Techniques/Bear Hunter System|Bear Hunter System]] can become a prettier version of linear notes.
...
This is why [[wiki/Techniques/Aim|Aim]], [[wiki/Techniques/Shoot|Shoot]], and [[wiki/Techniques/Skin|Skin]] matter. They are not just note-making steps. They are ways to push the learner toward schema-building cognition.
...
[[wiki/Techniques/Bear Hunter System|Bear Hunter System]] works only when each step creates the right cognition.

| BHS Step | Surface Version | Learning Version |
| --- | --- | --- |
| [[wiki/Techniques/Aim|Aim]] | List headings and make generic questions. | Generate importance, relationship, and purpose questions. |
| [[wiki/Techniques/Shoot|Shoot]] | Copy source explanations into a map. | Use sources to answer questions, revise chunks, and clarify relationships. |
| [[wiki/Techniques/Skin|Skin]] | Make the map neat. | Simplify, prioritize, and organize the structure so it can be retrieved. |
...
[[wiki/Techniques/Spaced Interleaved Retrieval|SIR]] and [[wiki/Techniques/WPW|WPW]] are valuable because they expose the level of thinking the learner must reach.
...
[[wiki/Techniques/Kolbs Experiential Cycle|Kolbs Experiential Cycle]] is the reflection tool for this problem.
...
This links directly to [[wiki/Techniques/Marginal Gains|Marginal Gains]]: choose one small improvement in the thinking, not a vague plan to "study better."
