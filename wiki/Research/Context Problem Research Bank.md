---
title: "Context Problem Research Bank"
type: research
status: reference
created: 2026-08-22
updated: 2026-08-22
description: "Outside research on the same fault as journal/2026-08-22-the-context-problem.md: LLM writing that uses a word, a connection, or a referent the page has not given. Claim ledger, X, papers, wiki MOS, tools, and which suggested fixes belong to the class that already failed here."
tags:
  - research
  - writing
  - llm
  - llm-wiki
  - context-problem
in-reply-to: "journal/2026-08-22-the-context-problem.md"
---
...
The local record lives in [[journal/2026-08-22-the-context-problem|The Context Problem]]. This bank does not rerun that audit. It asks whether other people have hit the same fault, what they call it, what they tried, and what of that is the same class as the fixes that already failed here.
...
- [[02 - System/Research Pipeline for AI Agents|Research Pipeline]] §3.2–3.3 and §4 (detectors from strikes, self-administered quality tests)
...
Verdict codes from [[02 - System/Research Pipeline for AI Agents|Research Pipeline]] §2. Vault-only material never earns an S.
...
From [WP:Make technical articles understandable](https://en.wikipedia.org/wiki/Wikipedia:Make_technical_articles_understandable):
...
From [MOS:NOFORCELINK](https://en.wikipedia.org/wiki/Wikipedia:Manual_of_Style/Linking):
...
[[02 - System/Readers|Readers]] already says this for wiki pages: "A link on the page tells them what is on the other side; they will not follow it to find out what a word means."
...
**LLM wiki systems.** STORM, Co-STORM, OmniThink, WikiSum, Karpathy compile, Grokipedia. They score organization, coverage, citations, sometimes Flesch. None score "a reader who has only this page can follow it." STORM editors' named writing error is asserted connections. Wikipedia now says LLMs should not generate new articles from scratch ([WP:LLM](https://en.wikipedia.org/wiki/Wikipedia:Writing_articles_with_large_language_models)). Grokipedia vs Wikipedia (Yasseri 2025): longer, higher grade level, lower lexical diversity, fewer refs per 1,000 words. Harder, not clearer.
