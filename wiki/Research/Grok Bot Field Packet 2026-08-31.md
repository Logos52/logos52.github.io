...
- **One helper declares a finding.** Watch writes whether a site answered. Field writes whether a public write-up would change a file. They do not both get to name the same fact. Absorbed into [[wiki/Systems/AI & Agentic Systems/Grok Bot Primer|Bot Operating Rules]].
