...
- **The local-agent layer is already the working stack here, not an aspiration** — see [[wiki/Systems/AI & Agentic Systems/Current Agentic LLM Stack|Current Agentic LLM Stack]] and [[wiki/Systems/AI & Agentic Systems/Hermes Agent|Hermes Agent]]. Operating local agents puts the floor at Level 2.
...
- [[wiki/Systems/AI & Agentic Systems/Hermes Agent|Hermes Agent]]
