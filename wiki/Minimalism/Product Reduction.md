...
| --- | --- | --- |
| Easy-item bias | Small trash leaves while large burdens stay. | Reduce high [[wiki/Minimalism/Ownership Cost|Ownership Cost]] first. |
| Resale delay | Items linger because they might sell. | Use [[wiki/Minimalism/Exit Strategy For Objects|Exit Strategy For Objects]]. |
