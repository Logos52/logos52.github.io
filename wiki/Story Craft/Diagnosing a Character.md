...
1. **Wound / Ghost** — a concrete backstory injury that installed the character's false belief. [[wiki/Story Craft/The Wound and the Lie|The Wound and the Lie]]
2. **Lie** — the false belief about self or world the character holds at page one, shown as behavior. Same page.
3. **Want vs Need** — a nameable external goal that stands in for, and fights, the internal truth; if winning the Want would also grant the Need, the arc has no gap. [[wiki/Story Craft/The Change Arc|The Change Arc]]
4. **One defining contradiction, shown before named** — a single interior tension that distorts a costly choice on the page. A trait pile is not a contradiction. [[wiki/Story Craft/Round Characters and the Telling Detail|Round Characters and the Telling Detail]]
5. **Distinct voice** — diction, rhythm, tics, and the topics the character refuses to name, so a line is assignable before its tag. [[wiki/Story Craft/Character Voice|Character Voice]]
6. **Arc type, and whether it duplicates the cast's dominant type** — the single check that most often explains "well-built but thin," because a competent arc reads flat when it rhymes with five others. [[wiki/Story Craft/Arc Types|Arc Types]]
7. **Signature object / motif** — a concrete thing that carries the interiority the scene has no room to state. [[wiki/Story Craft/Motif and Symbol|Motif and Symbol]]
8. **Plant → payoff chain** — every arc-closing beat paid for by a quiet plant the reader already lived through. [[wiki/Story Craft/Companion Arcs and Party Banter|Companion Arcs and Party Banter]]
9. **A home lesson for the crisis** — the pivotal beat owns a scene, not an assertion in the bible and not a slot shared three ways. [[wiki/Story Craft/Spotlight Rotation|Spotlight Rotation]]
10. **Web edges** — built, revealing relationships to more than one other character, each doing relationship-work and revelation-work at once. [[wiki/Story Craft/Foils and Pairings|Foils and Pairings]] · [[wiki/Story Craft/The Character Web|The Character Web]]
11. **Submerged backstory** — the iceberg's hidden mass fully worked out, so a withhold reads as loaded rather than hollow. [[wiki/Story Craft/The Iceberg and World as Pressure|The Iceberg and World as Pressure]]
...
- Two leads return near-identical mark patterns: the shared fault is ensemble-level (arc-type monotony, one theme unspread), and belongs to [[wiki/Story Craft/The Character Web|The Character Web]], not to either character.
...
- [[wiki/Story Craft/The Character Web|The Character Web]] — the ensemble-level version of this audit, when two characters share a fault.
- [[wiki/Story Craft/Arc Types|Arc Types]] — check 6, the one that most often explains "well-built but thin."
- [[wiki/Story Craft/Round Characters and the Telling Detail|Round Characters and the Telling Detail]] — checks 4 and 7, the cheap texture fixes.
- [[wiki/Story Craft/Story Craft|Story Craft]] — the wing this checklist indexes.
