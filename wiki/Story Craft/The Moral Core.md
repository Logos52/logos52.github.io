...
The same questions the craft asks of a character work on a person, and they are harder than they look because the core is the list of laws with receipts, never the list of laws admired.

- Which law have you actually paid for — and what did it cost?
- What specific event forged it? (A Ghost is an event, never a mood.)
- What test would price it today, aimed at the thing you'd least like billed?

### The shapes a core takes
...
## Strong cores in fiction

Each blurb runs the loop: the law, the forge, the test.

**Captain America — Steve Rogers.** The law: compromise where you can; where you can't, don't. Forged before the serum — the kid too small to win a fight who kept getting up anyway; Erskine's test question ("do you want to kill Nazis?") selects for the core, and the serum only amplifies it. The test arrives in *Civil War*, which prices the line against the family he leads, and he pays with the shield.

**Iron Man — Tony Stark.** A core forged mid-life, in a cave, with a box of scraps: Yinsen's dying line ("don't waste your life") converts genius into permanent liability for what the hands make. The test recurs in every film as an offer to hand the making over — the Senate, Ultron, the Accords — and the answer is always his own body on the wire.

**Luke Skywalker.** The law: nobody is beyond saving. Forged from a farm boy's borrowed ideals into conviction across two mentors' deaths. The test is the throne room's arithmetic — win the galaxy by killing his father — and the saber leaves his hand. The refusal, with the whole war on the other side of the scale, is the saga's cleanest core-test.

**Obi-Wan Kenobi.** The steward: a man who holds power his entire life and wants none of it, serving the order, then the student, then the student's son. Tested twice at full price — Mustafar charges duty against love and collects both, and the twenty years in the desert charge him with tending a hope that will never be his.

**Ser Duncan the Tall.** A hedge knight with no proof of knighthood who keeps the vow the anointed knights recite and forget: protect the weak. The test is Ashford Meadow — stepping between a prince and a puppeteer with royal blood's price fully known, then letting a trial of seven price it again. The core carries the least standing in Westeros and pays the most reliably.

**Egg — Aegon Targaryen.** A prince who chooses to see from below. Forged by the boots, the road, and service to a hedge knight. The test rides in his pocket: every hardship on the road would end the moment he says his name, and he doesn't say it.

**Jon Snow.** The oathkeeper whose oaths keep colliding — the Watch against the Starks, the vow against Ygritte, the letter of the oath against the living it was written to protect. The test at the Wall prices the vow's purpose over its wording; he lets the wildlings through and pays for it at the hands of his own men.

**Tyrion Lannister.** Cynicism worn over one law: kindness to broken things — the saddle drawn for Bran, the counsel given to Jon at the Wall, Sansa shielded at court. The test is the trial, where the mask stops working, the law is all that's left, and the family that never priced him hears exactly what he thinks of the bill.

**Jaime Lannister.** The redeemer: the record says Kingslayer, and the forge was the act itself — an oath broken to keep half a million people alive, carried silently because no one ever asked why. The bath at Harrenhal names the core; the hand lost defending Brienne re-forges it; the arc is the reputation and the law trading places.

**Ned Stark.** The steadfast at full price, and the sharpest fact in the set: a core has a hierarchy, and the hierarchy shows only at the top of the price range. Honor bends exactly once — a false confession to save his daughters — and the bending buys nothing. What a character will subordinate a law *to* is as defining as the law.

**Brienne of Tarth.** The oath kept in a world that finds it funny: vows to dead lords, service to people who can no longer receive it. Her test has no scene — it is every unwatched day on the road, where quitting would cost nothing because nobody would know.

**Maximus.** The steward at imperial scale: he holds the legions, the mob's love, and Marcus Aurelius's dying trust, and wants none of it — the engine of the whole film is a man trying to get home to a farm. Forged by Marcus's charge ("there was a dream that was Rome") and the family the Empire burns for it. The test is Commodus's whole project — turn Rome's servant into the arena's creature — and it prices cleanest over Tigris of Gaul: the Colosseum demands the kill, the emperor signals it, and Maximus drops the sword. He wins the Empire twice, the army at the start and the mob at the end, and hands it back both times; the wheat field is the only payment he ever wanted collected.

**Yoda.** Nine hundred years of the steward's law, and the heroes' one on-page failed test, named aloud by its own payer. The Clone Wars offer the Order a war to save the Republic; Yoda takes the generalship, fights the war his own doctrine forbids, and never sees the Sith running both sides of it. "Into exile I must go. Failed, I have" — a core-holder reading his own bill. Dagobah re-forges the law into "wars not make one great," and the second test inverts the steward's native one: Luke leaves for Cloud City over Yoda's objection, and the teacher watches the student buy the lesson at the price of a hand. Obi-Wan's desert tends someone else's hope; Yoda's swamp keeps vigil over his own failure.

**Cassian Andor.** The longest forge on modern screen: two seasons pricing one law in, event by event — Kenari, Maarva's funeral speech, Nemik's manifesto handed over like a debt, and Narkina 5's lesson that the Empire bills you whether you rebel or not ("one way out"). By *Rogue One* the core is load-bearing and the tests run quiet: ordered to assassinate Galen Erso on Eadu, he has the shot and doesn't take it; Scarif is a mission nobody orders, flown by volunteers who know the price going in. A change arc is a forge with the camera left running, and Andor is the proof at series length.

**Luthen Rael.** The shape the list above misses: payment as a permanent condition. The other cores get billed in scenes; Luthen *is* the bill — Kreegyr's thirty men spent to protect a mole, Cassian marked for death as a loose thread, decency burned daily as fuel. His monologue looks like a violation of this page's gag order and is its sharpest proof: every line itemizes a price already paid on-screen, and it is pulled out of him by his own agent demanding to know what he has ever sacrificed. A spoken core lands when the events precede the speech; the soapbox is the speech that precedes the events. "I burn my life to make a sunrise that I know I'll never see" — the one core in the set that pays in advance, with no witness and no receipt.

## The core on the other side

The loop is amoral machinery. The forge prices a law in whether or not the law is good, the test bills it whether or not the payer is the hero, and the audience believes a villain's price by exactly the same mechanism. What the other side adds is outcomes the hero list can't show: a test failed, a hierarchy surrendered, a law whose villainy lives in its content and never in its construction.
...
- [[wiki/Story Craft/The Wound and the Lie|The Wound and the Lie]] — the forge's raw material: Ghost → Lie → Want → Need
- [[wiki/Story Craft/Arc Types|Arc Types]] — where the forging happens decides the arc's shape
- [[wiki/Story Craft/The Change Arc|The Change Arc]]
- [[wiki/Story Craft/Diagnosing a Character|Diagnosing a Character]]
- [[wiki/Story Craft/Premise and Controlling Idea|Premise and Controlling Idea]] — the story-level law the cores argue
- [[projects/tsumugu|Tsumugu]] — the project the cast belongs to
