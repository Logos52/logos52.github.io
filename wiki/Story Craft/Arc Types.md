...
- The Lie and Truth are stateable but only by the narrator — the reader has to be told them, never watches them as behavior or recognition. Next move: find the concrete carrier (the envelope, the photo, the hands) and delete the statement. See [[wiki/Story Craft/Interiority Through Action and Object|Interiority Through Action and Object]].
...
- [[wiki/Story Craft/Story Under a Vocabulary Ceiling|Story Under a Vocabulary Ceiling]] — why arc types get rationed across the cast and cores front-load to B3.
