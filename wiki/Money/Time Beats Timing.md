...
The horizon applies to invested surplus, not to living. Experiences have closing windows. Time-bucketing — matching an experience to the decade it is still possible — is the correct exception, governed by [[wiki/Money/Define Enough|Define Enough]]. What the right vehicles are for a given situation belongs to [[projects/wnac|WNAC]].
...
The repair is process design, not better forecasts: automatic contributions, a calendar rebalance, a no-news rule. [[wiki/Decision Making/Judging a Decision by Its Process|Good Decisions]] owns process over outcomes one level up.

## Links

- [[wiki/Money/Investing and Budgeting Mindsets|Investing & Budgeting Mindsets]] — the hub this stay-in claim sits on.
- [[wiki/Money/The Savings Rate Is the Master Lever|The Savings Rate Is the Master Lever]] — the other lever: how much is on the horizon.
- [[wiki/Money/Define Enough|Define Enough]] — the finish line, and the exception for living that has closing windows.
- [[projects/wnac|WNAC]] — vehicle choice for a given life.
- [[wiki/Decision Making/Judging a Decision by Its Process|Good Decisions]] — process over outcomes, one level up.
