---
title: "Standing Research Agents"
type: system
status: seed
created: 2026-08-12
updated: 2026-08-12
...
**Intake** feeds the research banks. It sweeps the standing sources — feeds, paper servers, the channels worth following — scores each find for relevance and novelty, and files queue deltas for review. Banks like the [[wiki/Research/Two Egos Research Bank|Two Egos Research Bank]] were gathered by parallel agents inside sessions; Intake runs the same collection as a standing lane, so the banks fill between sessions instead of during them.
