...
Storytelling; Framing; Mental Model; Desire Line; Error, Design; Error, Human; Five Hat Racks; Iteration; Minimum-Viable Product; Nudge; Prototyping; Rosetta Stone; Anchoring; Cost-Benefit; Feedback Loop; Kano Model; Pareto Principle; Priming; Root Cause; Stickiness.
...
| Causal Reductionism | 5 | 2 | 2 | 5 | Own | A tendency to fixate on one cause when solving problems, ignoring the reality of multiple causes |
...
| Ockham’s Razor | 5 | 2 | 4 | 5 | Own | Given a choice between functionally equivalent designs, the simplest design should be selected |
...
| Brooks’ Law | 4 | 2 | 2 | 4 | Own | For certain types of projects, adding people to speed things up inadvertently slows them down |
...
| Expectation Effects | 4 | 2 | 3 | 4 | Own | Changes in perception or behavior resulting from personal expectations or expectations of others |
...
| Paradox of Unanimity | 4 | 2 | 1 | 4 | Own | Extreme agreement in a diverse population is more likely the result of error than of consensus |
...
| Premature Optimization | 4 | 2 | 4 | 4 | Own | Making elements of a design efficient before they are recognized as important or even needed |
...
| Pareto Principle | 4 | 4 | 3 | 5 | Augment | A small percentage of variables in any large system is responsible for most of its behavior |
...
| Iteration | 4 | 4 | 4 | 4 | Augment | Designing things in phases, each phase building on the last, until a desired result is achieved |
...
| Serial Position Effects | 3 | 4 | 4 | 4 | Delegate | Things at the beginnings and ends of sequences are more memorable than things in the middle |
| Signal-to-Noise Ratio | 3 | 4 | 5 | 4 | Delegate | The ratio of relevant to irrelevant information |
| Accessibility | 3 | 4 | 5 | 3 | Delegate | Things should be designed to be usable, without modification, by as many people as possible |
...
| Feedback | 3 | 5 | 5 | 3 | Delegate | Information about status or performance used for confirmation, decision-making, and improvement |
...
| Performance Load | 3 | 4 | 5 | 3 | Delegate | The greater the effort required to complete a task, the less likely the task will be completed |
| Poka-Yoke | 3 | 4 | 4 | 3 | Delegate | A thing designed to prevent defects and errors |
| Progressive Disclosure | 3 | 4 | 5 | 3 | Delegate | A method of managing complexity in which only necessary or requested information is displayed |
...
| Legibility | 3 | 4 | 5 | 2 | Delegate | The visual clarity of text, generally based on size, typeface, contrast, line length, and spacing |
...
| Fitts’ Law | 2 | 4 | 4 | 2 | Delegate | The time required to touch a target is a function of the target size and the distance to the target |
| Golden Ratio | 2 | 5 | 3 | 2 | Delegate | A ratio within the elements of a form, such as height to width, approximating 1.618 |
...
| Interference Effects | 3 | 3 | 3 | 3 | Low-lev | Things that trigger conflicting thought processes, reducing reaction and thinking efficiency |
...
| Uncanny Valley | 3 | 3 | 3 | 3 | Low-lev | Abstract and realistic depictions of human faces are appealing but faces in between are not |
...
| Entry Point | 3 | 3 | 4 | 2 | Low-lev | A point of physical or attentional entry that sets the emotional tone for subsequent interaction |
| Five Tenets of Queuing | 3 | 3 | 2 | 2 | Low-lev | Five principles for improving the experience of waiting in lines |
| Gloss Bias | 3 | 3 | 3 | 2 | Low-lev | A preference for glossy versus dull objects. People find glossy objects more interesting and attractive |
