...
Learning goes better when the brain has a target before the source starts pouring in. Aim is the first step of [[wiki/Dimensions/Deep Processing/Bear Hunter System|Bear Hunter System]].

The practical goal: create high-quality questions that make you search for importance, relationships, and chunks.

[[wiki/Dimensions/Deep Processing/Prestudy|Prestudy]] is the timing layer that often comes before Aim. Prestudy creates the rough frame; Aim sharpens that frame into questions.
...
Then move into [[wiki/Dimensions/Deep Processing/Shoot|Shoot]].
...
| Problem | Fix |
| --- | --- |
| Too many questions | Keep only questions that would change your map. |
| Questions too basic | Convert "what is X?" into "why does X matter?" |
| No curiosity | Ask what confused you, surprised you, or seems useful. |
