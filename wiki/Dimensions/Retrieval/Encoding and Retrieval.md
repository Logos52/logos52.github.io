...
- Craik, F. I. M., & Lockhart, R. S. (1972). Levels of processing: A framework for memory research. *Journal of Verbal Learning and Verbal Behavior*. Deeper, more relational intake slows forgetting.
...
- Ebbinghaus, H. (1885/1913). *Memory: A Contribution to Experimental Psychology*. Forgetting is real; retrieval never goes to zero.
- Roediger, H. L., & Karpicke, J. D. (2006). Test-enhanced learning: Taking memory tests improves long-term retention. *Psychological Science*. A test beats restudy on a delayed test within days.
