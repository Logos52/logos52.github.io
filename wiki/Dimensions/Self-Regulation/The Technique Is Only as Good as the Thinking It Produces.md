...
1. **Technique**: the visible method, such as mapping, highlighting, retrieval, BHS, or interleaving.
2. **Thinking**: the mental operation the method is supposed to force, such as comparison, evaluation, organization, reconstruction, or transfer.
3. **Knowledge**: the structure created by that thinking.
4. **Performance**: the ability to remember, explain, apply, adapt, and solve.
...
The steps of a method can look correct while the cognition is wrong. A mind map can become decoration. Highlighting can become recognition. Retrieval can become guessing without diagnosis. [[wiki/Dimensions/Deep Processing/Bear Hunter System|Bear Hunter System]] can become a prettier version of linear notes.
...
That is why [[wiki/Dimensions/Deep Processing|Deep Processing]] matters. Without a higher-order schema, memory fades quickly and volume becomes unsustainable.
...
This is why [[wiki/Dimensions/Deep Processing/Aim|Aim]], [[wiki/Dimensions/Deep Processing/Shoot|Shoot]], and [[wiki/Dimensions/Deep Processing/Skin|Skin]] matter. They are not just note-making steps. They are ways to push the learner toward schema-building cognition.
...
1. What result am I trying to create?
2. What kind of thinking would create that result?
3. What technique is supposed to trigger that thinking?
4. Did I actually think that way?
5. What evidence shows the knowledge improved?
6. If the result did not improve, was the issue the technique, my execution, or my diagnosis?

This is the practical bridge between [[wiki/Dimensions/Self-Regulation|Self-Regulation]] and technique training. The learner is not only using methods. The learner is monitoring whether the methods are doing their job.
...
These signals help guide adjustment before formal performance data is available. [[wiki/Dimensions/Retrieval/Spaced Interleaved Retrieval|Spaced Interleaved Retrieval]] still has to test the knowledge.
...
[[wiki/Dimensions/Deep Processing/Bear Hunter System|Bear Hunter System]] works only when each step creates the right cognition.

| BHS Step | Surface Version | Learning Version |
| --- | --- | --- |
| [[wiki/Dimensions/Deep Processing/Aim|Aim]] | List headings and make generic questions. | Generate importance, relationship, and purpose questions. |
| [[wiki/Dimensions/Deep Processing/Shoot|Shoot]] | Copy source explanations into a map. | Use sources to answer questions, revise chunks, and clarify relationships. |
| [[wiki/Dimensions/Deep Processing/Skin|Skin]] | Make the map neat. | Simplify, prioritize, and organize the structure so it can be retrieved. |
...
[[wiki/Dimensions/Self-Management/Kolbs Experiential Cycle|Kolbs Experiential Cycle]] is the reflection tool for this problem.
...
This links directly to [[wiki/Dimensions/Mindset/Marginal Gains|Marginal Gains]]: choose one small improvement in the thinking, not a vague plan to "study better."
