...
If the strategy does not trigger the intended thinking, it will not create the intended knowledge. If the knowledge is not organized correctly, the result will not improve.
...
This is the core of [[wiki/Concepts/The Shortcut Problem|The Shortcut Problem]].
...
1. The method was starting to work, but progress was too subtle to notice yet.
2. The method was not being executed with the intended thinking.
...
1. What is the result I wanted?
2. What kind of thinking should create that result?
3. What thinking did the technique actually trigger?
4. Where did I take a shortcut?
5. Did I quit before the skill had time to develop?
