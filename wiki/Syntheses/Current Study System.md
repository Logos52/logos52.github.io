...
The broader model is [[wiki/Dimensions/Dimensions of Learning|Dimensions of Learning]]. Encoding creates the structure. Retrieval stress-tests it. Self-regulation decides what to change next.

## Operating Loop

1. Start with a topic, syllabus area, reading, lecture, or project requirement.
2. Use [[wiki/Techniques/Bear Hunter System|Bear Hunter System]] to form a useful structure before getting buried in details.
3. Convert that structure into a map, question set, or explanation that can be retrieved later.
4. Schedule [[wiki/Techniques/Spaced Interleaved Retrieval|Spaced Interleaved Retrieval]] soon enough to expose gaps before the knowledge decays.
5. During retrieval, vary the task format, topic mix, difficulty, and angle of questioning.
6. Use failures as diagnostic signals: missing facts, weak relationships, poor chunking, shallow understanding, or insufficient application practice.
7. Re-encode the weak parts rather than repeating the whole topic passively.
