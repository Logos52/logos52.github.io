...
1. Know where attention should be.
2. Notice quickly when attention drifts.
3. Remove [[wiki/Decision Making/Decisional Delays|Decisional Delays]] before they break flow.
...
This is where Attention Management connects directly to [[wiki/Decision Making/Decisional Delays|Decisional Delays]]. A small "what now?" gap can become the point where attention leaks into messages, browsing, food, chores, or easier work.
