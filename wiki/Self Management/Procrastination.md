...
1. Stop treating procrastination as one problem.
2. Identify the specific trigger and avoidance behavior.
3. Lower the activation energy of the first action.
4. Change the environment so success requires less willpower.
5. Use accountability or consequences only when lighter tools are not enough.
...
Procrastination and [[wiki/Self Management/Flow State|Flow State]] are often opposites in practice.
