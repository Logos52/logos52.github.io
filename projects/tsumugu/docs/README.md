---
title: "Tsumugu docs — index"
type: project-doc
project: tsumugu
draft: true
created: 2026-06-09
source: "Projects/tsumugu/docs — engine repo is canonical"
tags:
  - projects
  - tsumugu
---
...
- **[`PRD.md`](https://github.com/Logos52/tsumugu/blob/main/PRD.md)** — the source of truth for *intent*: goals, scope, success criteria, decisions. When intent and these guides disagree, the PRD wins.
- **[`STATUS.md`](https://github.com/Logos52/tsumugu/blob/main/STATUS.md)** — the audited record of *reality*: what is built and validated, in chronological detail. When you want "is X actually done?", read STATUS.
- **[`AGENTS.md`](https://github.com/Logos52/tsumugu/blob/main/AGENTS.md)** — the build guide for coding agents, with the phases as runnable workflows.
- **[`DECISIONS.md`](https://github.com/Logos52/tsumugu/blob/main/DECISIONS.md)** — how each open question was resolved, with the defaults on the record.
- **[`DESIGN-HISTORY.md`](https://github.com/Logos52/tsumugu/blob/main/DESIGN-HISTORY.md)** — the dated provenance of the design (open / prior-art posture).
- **[`PACK-AUTHORING.md`](https://github.com/Logos52/tsumugu/blob/main/PACK-AUTHORING.md)** — the pack-interface reference; [Extending Tsumugu](./06-extending.md) is the fuller walkthrough.
