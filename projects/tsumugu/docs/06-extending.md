...
For builders. How to add a language, run the generation toolchain, work with the ports, and stay inside the hard rules. This is the fuller companion to the [`PACK-AUTHORING.md`](https://github.com/Logos52/tsumugu/blob/main/PACK-AUTHORING.md) reference.
...
For the audited test counts and what each suite covers, see [`STATUS.md`](https://github.com/Logos52/tsumugu/blob/main/STATUS.md). For intent and the open questions, see [`PRD.md`](https://github.com/Logos52/tsumugu/blob/main/PRD.md) §12 — surface those rather than guessing.
