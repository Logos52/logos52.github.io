...
What Tsumugu actually does today, surface by surface. This is the "what's there" view; for the audited, dated record of each item read [`STATUS.md`](https://github.com/Logos52/tsumugu/blob/main/STATUS.md).
