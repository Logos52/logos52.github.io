...
**General direction:**  
Build a sustainable deep work practice that supports high-quality creative and intellectual output.

**Medium term anchored goal:**  
By the end of 2025, be able to consistently do 4+ hours of deep work per day, 5 days a week, with high focus and energy.

#### What mindsets and attributes are needed? (Who achieves this?)

| Mindset / Attribute | Current | Final | Notes |
|---------------------|---------|-------|-------|
| Self-discipline | 6/10 | 9/10 |  |
| Energy management | 5/10 | 8/10 |  |
| Focus & presence | 7/10 | 9/10 |  |

#### What skills are needed? (How do they achieve this?)

| Skill | Current | Final | Notes |
|-------|---------|-------|-------|
| Deep Work (90+ min blocks) | 6/10 | 9/10 |  |
| Energy regulation | 5/10 | 8/10 |  |
| Distraction management | 7/10 | 9/10 |  |

#### Checklist processes required for this skill

- [ ] Morning deep work block (90–120 min)
- [ ] Afternoon deep work block (90 min)
- [ ] End-of-day review
