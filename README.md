...
This repository is an LLM-operated research wiki. Raw sources are collected, then compiled into linked markdown pages that can be queried, audited, and extended over time.

It follows the LLM-wiki pattern: raw sources are immutable evidence, `wiki/` is the persistent compiled artifact, and `AGENTS.md` is the schema that tells the LLM how to maintain the wiki.
...
This repository should contain original notes, summaries, citations, links, and permissively licensed assets.
