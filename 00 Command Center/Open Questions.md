...
Use this file as the queue of unresolved questions that should drive future source collection, wiki expansion, and outputs.

## System Design

- What is the smallest useful structure for an LLM-maintained markdown wiki?
- When does a simple markdown wiki stop being enough and need search, RAG, or a database?
- What metadata is actually useful for long-term maintenance, and what becomes ceremony?
- How should raw copyrighted source material be handled in a public repo?
...
- What is the smallest daily radar-building practice that would fit into an existing learning session?
- How can productive cognitive effort be distinguished from unproductive overload?
- Which old learning habits are most likely to reappear when learning technical material?
- What should replace pages covered, notes written, and videos watched as progress metrics?
- Which Obsidian note formats best support thinking on paper without creating cleanup debt?
...
- Which retrieval formats best match my real target performances?
...
- Which of the five dimensions is currently my main bottleneck?
...
- Which dimension should be upgraded first this month: foundation, growth, or transfer?
- Which four-step practice track should be active this week?
...
- What is the simplest local search tool worth adding?
- Should source indexing be generated from frontmatter, file paths, or both?
- Can a health check produce useful diffs without over-editing the wiki?
...
<!-- The three "(added 2026-05-25 health check)" sections were moved to outputs/generated-questions.md on 2026-05-27, and AGENTS.md step 7 now redirects future auto-appends there. This file is Wedge's personal log. -->
