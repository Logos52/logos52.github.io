...
A map of the money side of the knowledge base — the mindsets and first principles behind budgeting and investing, distilled from books that teach temperament over tactics. The tactics change with the market; the mindsets don't. This feeds [[projects/wnac|WNAC]] (where AI meets the budgeting and investment loop) and the budgeting and investment nodes the base is growing.

Each book gets promoted to a standalone note as it's read; until then its takeaways live here as bullets.

## The reading list

### [[wiki/Money/The Almanack of Naval Ravikant|The Almanack of Naval Ravikant]] · Eric Jorgenson — ✓ read

Wealth as a learnable skill, not luck. *(Full note: [[wiki/Money/The Almanack of Naval Ravikant]].)*
...
- **Things cost more than their price** — every object taxes attention and upkeep ([[wiki/Minimalism/Ownership Cost|ownership cost]]).
...
- [[projects/wnac|WNAC]] — the applied side: AI in the budgeting and investment loop.
- Naval, in depth: [[wiki/Concepts/The Age Of Nonlinear Returns]], [[wiki/Concepts/A Motorcycle for the Mind]], [[wiki/Concepts/A Return to Code]].
- Minimalism, the spending side: [[wiki/Minimalism/Ownership Cost]], [[wiki/Minimalism/Minimalism as Systems Design]], [[wiki/Minimalism/Product Reduction]].
- Decision-making: [[wiki/Decision Making/Positional Decisions and Expected Value]], [[wiki/Decision Making/Judging a Decision by Its Process]].
