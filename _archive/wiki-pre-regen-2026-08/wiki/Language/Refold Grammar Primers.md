...
The [[wiki/Language/Vietnamese Grammar Primer|Vietnamese Grammar Primer]] uses this structure as a template, but the content should be rebuilt around Vietnamese rather than copied from Japanese.
