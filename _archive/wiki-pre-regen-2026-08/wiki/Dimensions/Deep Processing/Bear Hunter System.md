...
0. [[wiki/Dimensions/Deep Processing/Prestudy|Prestudy]]: create the rough frame before the main learning event.
1. [[wiki/Dimensions/Deep Processing/Aim|Aim]]: create the right questions before learning.
2. [[wiki/Dimensions/Deep Processing/Shoot|Shoot]]: use sources to answer those questions and build the map.
3. [[wiki/Dimensions/Deep Processing/Skin|Skin]]: clean the map into a final structure you can retrieve from memory.
