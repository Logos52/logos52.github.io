...
For parseable operational history, use [[log|log.md]]. This page is a human-readable summary.

## 2026-05-02

- Created phase 1 vault skeleton.
- Added command center, repo rules, templates, wiki entry points, and Git ignore policy.
