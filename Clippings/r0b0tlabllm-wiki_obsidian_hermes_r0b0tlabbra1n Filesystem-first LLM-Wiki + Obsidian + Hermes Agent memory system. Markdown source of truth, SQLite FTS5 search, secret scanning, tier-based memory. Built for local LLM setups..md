---
title: "r0b0tlab/llm-wiki_obsidian_hermes_r0b0tlabbra1n: Filesystem-first LLM-Wiki + Obsidian + Hermes Agent memory system. Markdown source of truth, SQLite FTS5 search, secret scanning, tier-based memory. Built for local LLM setups."
source: "https://github.com/r0b0tlab/llm-wiki_obsidian_hermes_r0b0tlabbra1n"
author:
published:
created: 2026-05-17
description: "Filesystem-first LLM-Wiki + Obsidian + Hermes Agent memory system. Markdown source of truth, SQLite FTS5 search, secret scanning, tier-based memory. Built for local LLM setups. - r0b0tlab/llm-wiki_obsidian_hermes_r0b0tlabbra1n"
tags:
  - "clippings"
---
## llm-wiki\_obsidian\_hermes\_r0b0tlabbra1n

> A filesystem-first LLM-Wiki + Obsidian + Hermes Agent memory system. Markdown is source of truth. Indexes are rebuildable acceleration layers. Built by @mr-r0b0t on X — r0b0tlab.
