...
source: "https://x.com/akshay_pachaar/article/2054564519280804028"
author:
  - "[[Akshay 🚀 (@akshay_pachaar)]]"
published: 2026-05-13
created: 2026-05-17
description: "Everything you need to understand and customize Hermes Agent. Self-evolving skills, three-tier memory, GEPA optimization, and going from 1 t..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HIIq8UxbwAAb5ul?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HINHPsHaEAAlF8u?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HIDv6xXbcAA1GA-?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HIDxrXxboAAPXCn?format=jpg&name=large)
...
Everything flows through a single AIAgent class in a run\_agent.py script. CLI, messaging gateway, batch runner, IDE integration: they're all entry points into the same core agent.

This is what makes the platform-agnostic story actually work.

![Image](https://pbs.twimg.com/media/HIGK0BvbAAAcfVS?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HIGPqrIakAA9ZIV?format=jpg&name=large)
...
For deeper persistent memory, Hermes ships with [8 pluggable providers](https://hermes-agent.nousresearch.com/docs/user-guide/features/memory-providers) that run alongside built-in memory (never replacing it). Only one can be active at a time.
...
![Image](https://pbs.twimg.com/media/HIM2tE_aYAAB5YW?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HIGQT-AasAEnQoT?format=jpg&name=large)
...
This is the core differentiator. The agent creates its own skills autonomously using the skill\_manage tool. Skill creation triggers when:
...
The tool supports six actions: create, patch (targeted fix, preferred because it's token-efficient), edit (full rewrite), delete, write\_file, and remove\_file.

![Image](https://pbs.twimg.com/media/HIBFygXbIAERgo-?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HIBIS1cagAAAAMN?format=jpg&name=large)
...
GEPA (Genetic-Pareto Prompt Evolution) is **not built into the Hermes runtime**. It lives in a companion repository (NousResearch/hermes-agent-self-evolution) and operates as an offline optimization pipeline. Published as an [ICLR 2026 Oral paper](https://arxiv.org/abs/2507.19457), MIT licensed.
...
![Image](https://pbs.twimg.com/media/HIM-svva8AE3-Ah?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HIBNCzFboAA3IJm?format=jpg&name=large)
...
Get a bot token from [@BotFather](https://t.me/BotFather) (run /newbot), then get your Telegram user ID from [@userinfobot](https://t.me/userinfobot).

That's it. You have a working agent:

<video preload="none" tabindex="-1" playsinline="" aria-label="Embedded video" poster="https://pbs.twimg.com/amplify_video_thumb/2054238694496948225/img/7bNjoXsAaSDGn3_g.jpg" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"><source type="video/mp4" src="blob:https://x.com/c0270f9d-2e6f-46cd-9c4f-37d86cfe3c7f"></video>

![](https://pbs.twimg.com/amplify_video_thumb/2054238694496948225/img/7bNjoXsAaSDGn3_g.jpg?name=large)
...
Hermes maintains its own official [Skills Hub](https://hermes-agent.nousresearch.com/docs/skills) with **687 skills across 18 categories**. The breakdown:
...
![Image](https://pbs.twimg.com/media/HIM7FoIaMAAv6d4?format=jpg&name=large)
...
<video preload="none" tabindex="-1" playsinline="" aria-label="Embedded video" poster="https://pbs.twimg.com/amplify_video_thumb/2054272698591940608/img/bEZmifxOYDEOnc5F.jpg" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"><source type="video/mp4" src="blob:https://x.com/8239306b-754a-4015-95ca-1f241de7281a"></video>

![](https://pbs.twimg.com/amplify_video_thumb/2054272698591940608/img/bEZmifxOYDEOnc5F.jpg?name=large)
...
![Image](https://pbs.twimg.com/media/HINC9DmaYAA5kqY?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HINBOTGacAAYTXc?format=jpg&name=large)
...
You can also chain jobs. One cron's output becomes the next cron's input via a context\_from flag. Useful for multi-stage automations where you want a research step to feed a writing step.
