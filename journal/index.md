...
- **[[journal/2026-08-15-what-works-grok-46-and-grok-bot|What works: Grok 4.6 and Grok Bot]]** — 15 August ranking. Writer seat retired 1 September. Banks, execution, and Bot still hold.
...
- **The writing process** — structure before lines, and naturalness over counts: a beat takes the length the conversation makes natural, and size marks exist only to keep imbalance visible. [[wiki/Systems/AI & Agentic Systems/The Writing Pipeline|Writing with a Structure Engine]] (the six working principles), grounded in [[wiki/Story Craft/Breaking the Story|Breaking the Story]], [[wiki/Story Craft/Structure for the Ear|Structure for the Ear]], and [[wiki/Story Craft/The Beat Board|The Beat Board]]. The working system built on them is [[journal/2026-07-27-the-break-comes-first|The Break Comes First]], unsigned.
