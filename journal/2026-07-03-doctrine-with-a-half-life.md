...
**The rot is real but uneven: tool-knowledge expires with the tool, and judgment-knowledge barely expires at all.**
...
| The lesson | It depends on | It files under |
| --- | --- | --- |
| "Chunk long documents for this model" | The tool's current shape | Dated tactics, stamped |
| "This phrasing improves the output" | The tool | Dated tactics, stamped |
| "Write down what correct means before delegating" | The shape of the work | Invariants |
| "The human owns whether it is true enough to use" | The work | Invariants |
