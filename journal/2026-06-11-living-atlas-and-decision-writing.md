...
**Focus shift, recorded.** Red Team is out of the map hubs; **Money** and **Chinese characters** are in. Wedge's stated interest has moved away from Red Team and from cos-as-a-project; toward Money and Mandarin (Tsumugu). Open questions on the home page now track the live threads (Tsumugu reading loop, money mindsets, YouTube reader) instead of the stale cos question. The About "What I write about" list was updated the same day: Red Team's bullet replaced by **Money** and **中文**. The reasoning, recorded for the record: Wedge served on a military Red Team; the university that taught the discipline has since closed, and its decision-support role is being superseded by AI. The wiki's Red Team pages stay — the domain just stops being a front-door focus.
...
**The home-linked twelve are done.** All five dimension pages plus their hub carry the full bar with corpus enrichment; First Principles of ICS, the Agentic Engineering hub, Focus Management, and the Minimalism hub got targeted passes (theses, descriptions, case-against sections, de-scaffolded headings); the Money and Chinese hubs were already near-bar from their recent writes. Side harvest: eight stale links fixed across the pass (moved pages, renamed files, raw/-linked sources on public pages) — every page the pass touched got its links verified against disk, a check the auto-catalog should eventually run wiki-wide. Money grew from two owners to six (through-lines promoted to concepts) and Minimalism gained Wanting Less, which is what made their condensed pages honest.
