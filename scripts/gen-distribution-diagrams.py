...
def family():
    ...
    b += n(516, 188, 140, 40, "Power law", TAN, "Heavy tail. The largest few carry the total.", "a few giants")
    ...
    b += arrow(340, 124, 340, 60, label=None, dash="4 3")
    ...
    b += arrow(408, 208, 516, 208, label="rate spread very wide", curve=-14)
    b.append('<text x="340" y="170" font-size="9.5" fill="currentColor" opacity=".55" text-anchor="middle">rate itself varies</text>')
    b.append('<text x="352" y="90" font-size="9.5" fill="currentColor" opacity=".5" text-anchor="middle">large mean looks normal</text>')
